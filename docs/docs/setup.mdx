...
kotlin {
    ...
    sourceSets {
        val commonMain by getting {
            dependencies {
+                implementation("com.moriatsushi.koject:koject-core:1.1.0-beta02")
            }
        }
    }
}
...
+    val processor = "com.moriatsushi.koject:koject-processor-app:1.1.0-beta02"
...
dependencies {
+    implementation("com.moriatsushi.koject:koject-core:1.1.0-beta02")
+    ksp("com.moriatsushi.koject:koject-processor-app1.1.0-beta02")
}
```
...
dependencies {
    // Add it according to your targets.
-    val processor = "com.moriatsushi.koject:koject-processor-app:1.1.0-beta02"
+    val processor = "com.moriatsushi.koject:koject-processor-lib:1.1.0-beta02"
    add("kspAndroid", processor)
    add("kspJvm", processor)
    add("kspJs", processor)
    add("kspIosX64", processor)
...
dependencies {
    implementation("com.moriatsushi.koject:koject-core:1.1.0-beta02")
-    ksp("com.moriatsushi.koject:koject-processor-app:1.1.0-beta02")
+    ksp("com.moriatsushi.koject:koject-processor-lib:1.1.0-beta02")
}
```
...
dependencies {
    ...
    implementation("com.moriatsushi.koject:koject-android-activity:1.1.0-beta02")
    // Inject ViewModel into Fragment
    implementation("com.moriatsushi.koject:koject-android-fragment:1.1.0-beta02")
    // ViewModelFactory only
    implementation("com.moriatsushi.koject:koject-android-viewmodel:1.1.0-beta02")
}
```
...
dependencies {
    ...
    implementation("com.moriatsushi.koject:koject-compose-viewmodel:1.1.0-beta02")
}
```
