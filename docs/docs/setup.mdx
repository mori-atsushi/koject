...
kotlin {
    ...
    sourceSets {
        val commonMain by getting {
            dependencies {
+                implementation("com.moriatsushi.koject:koject-core:1.1.0")
            }
        }
    }
}
...
+    val processor = "com.moriatsushi.koject:koject-processor-app:1.1.0"
...
dependencies {
+    implementation("com.moriatsushi.koject:koject-core:1.1.0")
+    ksp("com.moriatsushi.koject:koject-processor-app1.1.0")
}
```
...
dependencies {
    // Add it according to your targets.
-    val processor = "com.moriatsushi.koject:koject-processor-app:1.1.0"
+    val processor = "com.moriatsushi.koject:koject-processor-lib:1.1.0"
    add("kspAndroid", processor)
    add("kspJvm", processor)
    add("kspJs", processor)
    add("kspIosX64", processor)
...
dependencies {
    implementation("com.moriatsushi.koject:koject-core:1.1.0")
-    ksp("com.moriatsushi.koject:koject-processor-app:1.1.0")
+    ksp("com.moriatsushi.koject:koject-processor-lib:1.1.0")
}
```
...
dependencies {
    ...
    implementation("com.moriatsushi.koject:koject-android-core:1.1.0")
    // Activity support
