...
+                implementation("com.moriatsushi.koject:koject-test:1.2.0")
            }
        }
    }
}
...
+     testImplementation("com.moriatsushi.koject:koject-test:1.2.0")
+     kspTest("com.moriatsushi.koject:koject-processor-app:1.2.0")
}
```
