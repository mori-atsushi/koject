...
Using <TestProvides/>, you can replace dependencies.
In the following example, `SampleRepositoryImpl` is used in production, and `FakeSampleRepository` is used in testing.
